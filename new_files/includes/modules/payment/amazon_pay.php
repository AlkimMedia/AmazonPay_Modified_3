...
class amazon_pay
{
    ...
    function __construct()
    {
        ...
        $this->code        = __CLASS__;
        $this->title       = ConfigHelper::getConstant('MODULE_PAYMENT_AMAZON_PAY_TEXT_TITLE', 'Amazon Pay');
        $this->description = 'Version '.\AlkimAmazonPay\Config::PLUGIN_VERSION;
        $this->sort_order  = ConfigHelper::getConstant('MODULE_PAYMENT_AMAZON_PAY_SORT_ORDER');
        $this->enabled = ConfigHelper::isConstantTrue('MODULE_PAYMENT_AMAZON_PAY_STATUS');
        $this->info        = ConfigHelper::getConstant('MODULE_PAYMENT_AMAZON_PAY_TEXT_INFO', '');
