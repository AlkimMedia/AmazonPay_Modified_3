...
class TransactionHelper
{
    ...
    public function updateRefund(Refund $refund, $updateCharge = true): void
    {
        try {
    ...
    public function updateCharge(Charge $charge):void
    {
        try {
            $transaction = new Transaction();
    ...
    public function updateChargePermission(ChargePermission $chargePermission):void
    {
        try {
            $transaction = new Transaction();
    ...
    public function getTransaction($reference): ?Transaction
    {
    ...
    public function saveNewCharge(Charge $charge, $orderId = null): Transaction
    {
    ...
    public function saveNewChargePermission(ChargePermission $chargePermission, $orderId = null): Transaction
    {
        $transaction                = new Transaction();
    ...
    public function saveNewCheckoutSession(CheckoutSession $checkoutSession, $total, $currency, $orderId = null): Transaction
    {
     ...
     * @return Transaction[]
     */
    public function getOpenTransactions($orderId = null): array
    {
    ...
    public function refreshOrder($orderId): void
    {
    ...
    public function refreshTransaction(Transaction $transaction): void
    {
        try{
        ...
        if ($transaction->type === Transaction::TRANSACTION_TYPE_REFUND) {
            ...
            GeneralHelper::log('error', 'Unable to update transaction',  ['msg'=>$e->getMessage(), 'trace' => $e->getTraceAsString(), 'transaction' => $transaction->toArray()]);
        }
    }
