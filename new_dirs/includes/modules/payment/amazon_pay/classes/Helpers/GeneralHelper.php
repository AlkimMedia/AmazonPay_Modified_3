...
class GeneralHelper
{
    public static function autoDecode($str): string
    {
    ...
    public static function autoEncode($str): string
    {
        if (self::isUTF8($str)) {
            return $str;
        }
    ...
    public static function log($level, $msg, $data = null): void
    {
        ...
        file_put_contents($path, '[' . date('Y-m-d H:i:s') . '] ' . str_pad($_SERVER['REMOTE_ADDR'], 18) . $msg . "\n", 8);
