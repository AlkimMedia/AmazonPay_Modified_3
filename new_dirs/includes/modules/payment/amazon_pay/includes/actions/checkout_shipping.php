...
if (!empty($_GET['amazonCheckoutSessionId'])) {
    ...
    if (!$accountHelper->isLoggedIn()) {
        ...
        $passwordTime = time();
        $sql_data_array = [
            'customers_status' => \AlkimAmazonPay\ConfigHelper::getConstant('DEFAULT_CUSTOMERS_STATUS_ID_GUEST', 1),
            'customers_gender' => '',
    ...
    if ($accountHelper->isLoggedIn() && $accountHelper->getStatusId() !== (int)\AlkimAmazonPay\ConfigHelper::getConstant('DEFAULT_CUSTOMERS_STATUS_ID_GUEST', 1)) {
